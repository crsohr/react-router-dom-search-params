...
describe('withParams', () => {
  test('use default values', () => {
    ...
    act(() => {
      ...
      const registerProps = x => props = x;
      render(<Wrapper url="/"><TestWrapped registerProps={registerProps} /></Wrapper>, container);
    });
  ...
  test('handle string value', () => {
    let props, locationRef = {};
    act(() => {
      const TestWrapped = withParams(RegisterProps, {
        a: { defaultValue: '' },
      });
      const registerProps = x => props = x;
      render(<Wrapper locationRef={locationRef} url="/?a=value"><TestWrapped registerProps={registerProps} /></Wrapper>, container);
    });
  ...
  test('handle number value', () => {
    ...
    act(() => {
      ...
      const registerProps = x => props = x;
      render(<Wrapper locationRef={locationRef} url="/?a=2"><TestWrapped registerProps={registerProps} /></Wrapper>, container);
    });
  ...
  test('handle array', () => {
    ...
    act(() => {
      ...
      const registerProps = x => props = x;
      render(<Wrapper locationRef={locationRef} url="/?a=x,y"><TestWrapped registerProps={registerProps} /></Wrapper>, container);
    });
  ...
  test('handle object', () => {
    ...
    act(() => {
      ...
      const registerProps = x => props = x;
      render(<Wrapper locationRef={locationRef} url="/?ab=B&ac=C"><TestWrapped registerProps={registerProps} /></Wrapper>, container);
    });
